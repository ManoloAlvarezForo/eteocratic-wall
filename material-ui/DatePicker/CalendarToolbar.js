  ...
  (0, _createClass3.default)(CalendarToolbar, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.displayDate !== this.props.displayDate) {
        var nextDirection = muiTheme.isRtl ? 'right' : 'left';
        var prevDirection = muiTheme.isRtl ? 'left' : 'right';
    ...
    value: function render() {
      ...
      var nextButtonIcon = muiTheme.isRtl ? _react2.default.createElement(_chevronLeft2.default, null) : _react2.default.createElement(_chevronRight2.default, null);
      var prevButtonIcon = muiTheme.isRtl ? _react2.default.createElement(_chevronRight2.default, null) : _react2.default.createElement(_chevronLeft2.default, null);
...
CalendarToolbar.contextTypes = {
  muiTheme: MuiThemeProvider.propTypes.muiTheme
};
